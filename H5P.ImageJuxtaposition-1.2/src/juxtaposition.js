...
H5P.ImageJuxtaposition = function ($, Question) {
  /**
  ...
  C.prototype.attach = function ($container) {
    ...
    if (this.options.title) {      
      ...
      if(this.options.behavior.enableTTSButtons && this.options.headingTTS !== undefined) {
        H5P.Question.prototype.addTTSButton(this.options.headingTTS, "prependTo", $container.find(".h5p-image-juxtaposition-title"));
      }
    }
    ...
    var slider = new JXSlider('.h5p-image-juxtaposition-juxtapose', [{
      ...
      ttsID: this.options.imageAfter.afterTTS
    }], {
  ...
  JXSlider.prototype = {
     ...
     */
    displayLabel: function displayLabel(element, labelText, ttsID) {
    ...
    _init: function _init() {
      ...
      if(!this.parent.options.behavior.enableTTSButtons) {
        this.imgBefore.ttsID = undefined;
        this.imgAfter.ttsID = undefined;
      }

      // Display labels
      if (this.imgBefore.label) {
        this.displayLabel(this.leftImage, this.imgBefore.label, this.imgBefore.ttsID);
      }
      if (this.imgAfter.label) {
        this.displayLabel(this.rightImage, this.imgAfter.label, this.imgAfter.ttsID);
      }
