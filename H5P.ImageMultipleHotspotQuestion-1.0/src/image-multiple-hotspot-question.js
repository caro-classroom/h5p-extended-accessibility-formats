...
H5P.ImageMultipleHotspotQuestion = (function ($, Question) {
   ...
   */
   ImageMultipleHotspotQuestion.prototype.registerDomElements = function () {
    ...
    if(this.params.behaviour.enableTTSButtons && typeof this.params.imageMultipleHotspotQuestion.backgroundImageSettings.introductionTTS !== "undefined") {
      H5P.Question.prototype.addTTSButton(this.params.imageMultipleHotspotQuestion.backgroundImageSettings.introductionTTS, "introduction");
    }
   ...
   */
   ImageMultipleHotspotQuestion.prototype.createHotspotFeedback = function ($clickedElement, mouseEvent, hotspot) {
    ...
    if (this.hotspotFeedback.$element && this.hotspotFeedback.incorrect &&  this.params.behaviour.enableFeedback) {
    ...
    if (hotspot && hotspot.userSettings.correct && !hotspot.userSettings.selected) {
      ...
      if(this.params.behaviour.enableFeedback){
        this.score = this.score + 1;
        this.hotspotFeedback.$element.addClass('correct');
      } else {
        this.hotspotFeedback.$element.addClass('no-feedback');
      }
